...
func newOrderedPrehashedPostBuildInsertBenchmarkOptions(prebuildCount int, insertCount int, scenarioName string) *test_interfaces.BenchmarkOptions {
	options := test_interfaces.NewPostBuildInsertBenchmarkOptions(test_interfaces.SMT, prebuildCount, insertCount)
	options.ScenarioName = scenarioName
	options.UseOrderedPrehashedKeys = true
	return options
}
...
/*
func TestSMT_PrehashedOrdered_10kThenAdd2k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_50kThenAdd10k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_100kThenAdd20k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_200kThenAdd40k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_300kThenAdd60k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_500kThenAdd100k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_700kThenAdd140k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_900kThenAdd180k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_1MThenAdd200k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_2MThenAdd400k_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_5MThenAdd1M_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_10MThenAdd2M_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_20MThenAdd5M_NewElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_10kThenReinsert2k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_50kThenReinsert10k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_100kThenReinsert20k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_200kThenReinsert40k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_300kThenReinsert60k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_500kThenReinsert100k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_700kThenReinsert140k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_900kThenReinsert180k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_2MThenReinsert400k_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_10MThenReinsert2M_ExistingElements(t *testing.T) {
...
func TestSMT_PrehashedOrdered_25MThenReinsert5M_ExistingElements(t *testing.T) {
...
// Historical SMT-only benchmark kept commented out.
